...
//  Лабораторная 3
//
//  Created by Илья Гончаренко on 04.05.2023.
//Варіант 5 Створіть алгоритм для перетворення бінарного дерева на двозв'язний список, де обхід в серединному (симетричному / центрованому) порядку відповідає порядку вузлів у двозв'язному списку.
